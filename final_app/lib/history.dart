...
//import 'package:final_app/provider/calculator_provider.dart'; ทดสอบ provider
//import 'package:provider/provider.dart'; ทดสอบ provider
              ...
              itemBuilder: (BuildContext context, index) {
                ...
                return ListTile(
                  title: Text(newHistory.historyCal,
                      //context.read<CalculatorProvider>().equation, ทดสอบแสดงผลจากหน้า Cal ได้ แต่โชว์จาก DB ไมไ่ด้
